...
contains("static constexpr uint8_t NODE_INFO_PAGE_COUNT=4;", "Node Info has overview plus one page per remote request")
contains("screen==Screen::ContactDetails&&abs(tap.dy)>60", "Node Info pages use vertical swipe paging")
