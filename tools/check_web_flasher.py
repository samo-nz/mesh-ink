...
require('value="wipe"' in html and "FULL WIPE" in html, "separate destructive option")
require('id="wipe-word"' in html, "explicit full-wipe confirmation")
...
require('wipeWord.value.trim() === "ERASE"' in js, "typed confirmation for wipe")
require('window.confirm(' in js, "final explicit confirmation for wipe")
...
if args.build is None:
    ...
    print("PASS: flasher source checks (safe default, explicit erase, offsets, chip and SHA-256)")
else:
